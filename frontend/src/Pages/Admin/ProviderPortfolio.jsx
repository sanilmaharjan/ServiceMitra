        ...
        >
          ...
          <div style={{ flex: 1 }}>
            ...
            >
              ...
              <span
                className={`sm-badge ${provider.status === "verified" ? "sm-badge-success" : "sm-badge-warning"}`}
              >
                {provider.status}
              </span>
            </div>
        ...
        <div className="sm-grid" style={{ gridTemplateColumns: "1.5fr 1fr" }}>
          <div>
            ...
            <section className="sm-card">
              ...
              {!provider.portfolio || provider.portfolio.length === 0 ? (
                <p
                  style={{ color: "var(--sm-text-light)", fontStyle: "italic" }}
                >
                ...
                <div className="sm-grid">
                  {provider.portfolio.map((p, i) => (
                    <div
                      ...
                      style={{
                        padding: "1.25rem",
                        border: "1px solid var(--sm-gray-border)",
                        borderRadius: "12px",
                      }}
                    >
                      <div
          ...
          <div className="sm-grid" style={{ alignContent: "start" }}>
            ...
            >
              ...
              >
                NRS {(provider.earnings || 0).toLocaleString()}
              </div>
              <button
                className="sm-btn sm-btn-primary"
                style={{ width: "100%" }}
                onClick={() =>
                  navigate(`/admin/payments/${provider.id}`, {
                    state: { provider },
                  })
                }
              >
